...
1. Откройте вкладку [Actions](../../actions/workflows/build.yml), выберите
   **OpenWrt RAW client** и нажмите **Run workflow**. После окончания скачайте
   артефакт для архитектуры своего роутера.
